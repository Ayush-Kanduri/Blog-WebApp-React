...
const Error = () => {
	...
	return (
		<div className="text-5xl p-10">
			...
			<h2 className="mt-5 font-medium font-text text-text text-4xl">
				Oops! We're Lost in Space
			</h2>
			<p className="mt-2 pl-1 text-text text-xl font-text font-medium">
				Sorry, the page you are looking for is floating in a galaxy far, far
				away.
			</p>
			<img
				className="mt-5 ml-1 object-cover object-center rounded-lg shadow-lg w-4/12"
